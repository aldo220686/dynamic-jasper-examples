package com.almeda.reportes;

//https://github.com/intive-FDV/DynamicJasper/tree/master/src/test/java/ar/com/fdvs/dj/test
//https://github.com/intive-FDV/DynamicJasper/tree/master/src/test/java/ar/com/fdvs/dj/test
	import java.awt.Color;
	 ...
	 public class GroupsReportTestG1T8 extends BaseDjReportTest {
	 	...
	 	public DynamicReport buildReport() throws Exception {
	 		...
	 		detailStyle.setTextColor(Color.red);//agrego aldo
	 		...
	 		headerStyle.setTextColor(Color.blue);//agrego aldo
	 
	 		Style headerVariables = new Style();
	 		headerVariables.setFont(Font.ARIAL_BIG_BOLD);//headerVariables.setFont(Font.ARIAL_MEDIUM_BOLD);
	 //		headerVariables.setBorderBottom(Border.THIN());
	 		...
	 		drb
	 			...
	 			.setPrintColumnNames(false)//false
	 ...
	 //		drb.addGroup(g2); // add group g2
	 		...
	 		//alineacion del pie de pagina - aldo
